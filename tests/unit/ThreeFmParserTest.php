...
use All4m\Components\Scraper\ThreeFmParser;

class ThreeFmParserTest extends \Codeception\TestCase\Test
{
    ...
    {
        $data = '';
        $scraper = new ThreeFmParser(new All4mClient(''));
        $tracks = $scraper->parse($data);
